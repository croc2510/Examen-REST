...
public class MainRestController {
	...
	@ResponseStatus(HttpStatus.OK)
	private Movie getCity(@PathVariable Integer id) {
	...
	private List<Movie> getCityByName(@PathVariable String description) {
		return (List<Movie>) movieService.getMovieByName(description);
	}
